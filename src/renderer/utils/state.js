...
export const elements = {
  ...
  get btnEditorViewAggregation() { return $('#btn-editor-view-aggregation'); },
  get btnEditorViewSchema() { return $('#btn-editor-view-schema'); },
  get btnEditorViewIndexes() { return $('#btn-editor-view-indexes'); },
  get btnEditorExplain() { return $('#btn-editor-explain'); },
  get btnEditorQueryHistory() { return $('#btn-editor-query-history'); },
  get btnEditorImport() { return $('#btn-editor-import'); },
  get btnEditorExport() { return $('#btn-editor-export'); },
  ...
  get editorViewAggregationContent() { return $('#editor-view-aggregation-content'); },
  get editorViewSchemaContent() { return $('#editor-view-schema-content'); },
  get editorViewIndexesContent() { return $('#editor-view-indexes-content'); },
  get editorExplainPanel() { return $('#editor-explain-panel'); },
